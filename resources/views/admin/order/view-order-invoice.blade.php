            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <header>
                        ...
                        <h4>Billing Info</h4>
                        <address >
                            <p>{{ $customer->first_name.' '.$customer->lest_name }}</p>
                    ...
                    <article>
                        ...
                        <table class="inventory">
                            ...
                            <tr>
                                ...
                                <td><span data-prefix></span>TK.<span >{{ $orderDetail->product_price }}</span></td>
                                <td><span >{{ $orderDetail->product_quantity }}</span></td>
                                <td><span data-prefix>TK.</span><span>{{ $orderDetail->product_price*$orderDetail->product_quantity }}</span></td>
                            </tr>
                            @endforeach
                            </tbody>
                        </table>
