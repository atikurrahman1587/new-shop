                                ...
                                <div id="myTabContent" class="tab-content">
                                            ...
                                            @foreach($categoryProducts as $categoryProduct)
                                                <div class="col-md-4 product-tab-grid simpleCart_shelfItem">
                                                    <div class="grid-arr">
                                                        ...
                                                        <div class="women">
                                                            <h6><a href="{{ route('product-details', ['id'=>$categoryProduct->id, 'name'=>$categoryProduct->product_name]) }}">{{ $categoryProduct->product_name }}</a></h6>
                                                            <span class="size">XL / XXL / S </span>
                                                            <p style="color: #0A0A0A">TK.<em class="item_price">{{ $categoryProduct->product_price }}</em></p>
                                    ...
                                    <div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
                                        ...
                                        <div class="product-tab1">
                                            <div class="col-md-4 product-tab1-grid" style="margin-top: 5%;">
                                                <div class="grid-arr">
                                                    <div  class="grid-arrival">
                                                        <figure>
                                                            <a href="{{ route('product-details', ['id'=>$categoryProduct->id, 'name'=>$categoryProduct->product_name]) }}" class="new-gri">
                                            ...
                                            <div class="col-md-8 product-tab1-grid1 simpleCart_shelfItem" style="margin-top: 5%;">
                                                <div class="block">
                                                    <div class="starbox small ghosting"> </div>
                                                </div>
                                                <div class="women">
