                            ...
                            <ul id="myTab" class="nav1 nav1-tabs left-tab" role="tablist">
                                ...
                                <div id="myTabContent" class="tab-content">
                                            ...
                                            <div class="col-md-4 product-tab-grid simpleCart_shelfItem">
                                                <div class="grid-arr">
                                                    <div  class="grid-arrival">
                                                        <figure>
                                                            <a href="{{ route('product-details', ['id'=>$brandProduct->id, 'name'=>$brandProduct->product_name]) }}" class="new-gri">
                                                                <div class="grid-img">
                                                    ...
                                                    <div class="women">
                                                        <h6><a href="{{ route('product-details', ['id'=>$brandProduct->id, 'name'=>$brandProduct->product_name]) }}">{{ $brandProduct->product_name }}</a></h6>
                                                        <span class="size">XL / XXL / S </span>
                                                        <p style="color: #0A0A0A">TK.<em class="item_price">{{ $brandProduct->product_price }}</em></p>
                                                        <a href="{{ route('product-details', ['id'=>$brandProduct->id, 'name'=>$brandProduct->product_name]) }}" data-text="Add To Cart" class="my-cart-b item_add">Add To Cart</a>
                                                    </div>
                                                </div>
                                            </div>
                                            @endforeach
                                    ...
                                    <div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
                                        @foreach($brandProducts as $brandProduct)
                                        <div class="product-tab1" style="margin-top: 4%;">
